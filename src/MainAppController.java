...
public class MainAppController {
    ...
    private void addTask() {
        try {
            ...
            if (titleField.getText().isEmpty() || priorityBox.getValue() == null || dueDatePicker.getValue() == null) {
                ...
                throw new MissingFieldException("The table is Missing");
            }
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("The Task is not Selected");
            }
    ...
    // TODO: create Buat kelas MissingDateException exception
